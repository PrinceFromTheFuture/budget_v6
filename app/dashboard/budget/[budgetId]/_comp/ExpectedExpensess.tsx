...
export function ExpectedIncomes({ categories, budget }: { categories: Category[]; budget: Budget }) {
  ...
  return (
    <Card className="flex  m-0 w-full flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Budget expeted expenss</CardTitle>
        <CardDescription>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none text-lg font-semibold">
